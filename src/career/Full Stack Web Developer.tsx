...
export default function FullStackWebDeveloper() {
  return (<>
      <Navbar/>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
            <div className="max-w-3xl">
              ...
              Full Stack Web Developer • New Position
              </div>
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Full Stack Web Developer</h1>
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    ...
                    <li className="flex">
                      ...
                      <span>Design, develop, and maintain both the front-end and back-end of an AI-powered SaaS platform using Java, Spring Boot, and related technologies.
                      </span>
                      ...
                      <span>
                      Build robust and scalable RESTful APIs for seamless integration with front-end applications and AI services.
                      </span>
                    </li> <li className="flex">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>
                      Develop user interfaces with modern front-end frameworks like React, Angular, or Vue.js to create responsive, user-friendly applications.
                      </span>
                    </li>
                    <li className="flex">
                      <svg
                      ...
                      <span>Implement authentication and authorization mechanisms using OAuth, JWT, and other industry-standard practices.
                      </span>
                    </li>
                    <li className="flex">
                      <svg
                      ...
                      <span>
                      Collaborate with data scientists and engineers to integrate AI and machine learning models into the platform, ensuring smooth data flow between the front end, back end, and AI models.
                      </span>
                    </li>
                    <li className="flex">
                      <svg
                      ...
                      <span>
                      Optimize the performance, scalability, and security of the platform to handle large datasets and ensure a high-quality user experience.
                      </span>
                    </li>
                    <li className="flex">
                      <svg
                      ...
                      <span>Write clean, maintainable, and well-documented code, adhering to best practices and design patterns.
                      </span>
                    </li>
                    <li className="flex">
                      <svg
                      ...
                      <span>Conduct code reviews, write unit tests, and contribute to continuous integration and deployment (CI/CD) pipelines.
                      ...
                      <span>Collaborate with cross-functional teams to identify, troubleshoot, and resolve software bugs and performance issues.
                      ...
                      <span>Stay up-to-date with the latest trends in Java technologies, web development frameworks, and AI/ML integration to continuously improve the platform.
                 ...
                 <div className="mt-6 space-y-4">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex">
                      ...
                      <span>Bachelor’s or Master’s degree in Computer Science, Software Engineering, or a related field.
                    ...
                    <li className="flex">
                      ...
                      <span>
                      Proven experience as a Full Stack Developer with strong proficiency in Java and Spring Boot for back-end development.
                      </span>
                    </li> <li className="flex">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li className="flex">
                      ...
                      <span>Familiarity with cloud platforms (AWS, Google Cloud, or Azure) and cloud-based services for deploying web applications and managing large-scale infrastructure.
                      </span>
                    </li>
                    <li className="flex">
                      <svg
                      ...
                      <span>
                      Experience with database management (SQL, NoSQL, PostgreSQL, MongoDB) and designing efficient data models.
                      </span>
                    </li><li className="flex">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>
                      Strong understanding of CI/CD pipelines, version control (Git), and agile software development practices.
                      </span>
                    </li><li className="flex">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>
                      Knowledge of AI/ML concepts and their integration into web applications is a plus.
                      </span>
                    </li><li className="flex">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex">
                        ...
                        <span>Experience with microservices architecture and deploying distributed systems                  .</span>
                      </li>
                      <li className="flex">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span>
                        Familiarity with GraphQL for efficient data querying and management.
                        </span>
                      </li>
                      <li className="flex">
                        <svg
                        ...
                        <span>Knowledge of DevOps practices for managing infrastructure as code (e.g., Terraform, Ansible).
                        </span>
                      </li>
                      <li className="flex">
                        <svg
                        ...
                        <span>Experience with serverless architectures and technologies (e.g., AWS Lambda, Google Cloud Functions).
                        </span>
                      </li><li className="flex">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span>Familiarity with machine learning frameworks (e.g., TensorFlow, PyTorch) and integrating them into a web platform.
                        </span>
                      </li><li className="flex">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span>Understanding of data privacy and security best practices, particularly in SaaS and AI-driven applications.
                        .</span>
                      </li>
