        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.linkedin.com/company/adeptproofficial/?viewAsMember=true"
                className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition duration-300"
                aria-label="LinkedIn"
              >
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
              ...
              <a
                href="https://github.com/AdeptAIPro"
                className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition duration-300"
                aria-label="GitHub"
              >
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                AdeptAIPro  Inc. - Lucid Private Offices
...
McKinney, Texas, 75070
          ...
          <div>
            ...
            <div className="flex space-x-2">
              ...
              />
              <Button className="bg-[#5e19e6] text-secondary hover:bg-white hover:text-black transition duration-300">
                Subscribe
              </Button>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} AdeptAIPro. All rights reserved.
            </p>
